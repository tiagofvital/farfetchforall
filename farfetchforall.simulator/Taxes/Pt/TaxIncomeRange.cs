    ...
    public class TaxableIncome
    {
        ...
        public TaxableIncome()
        {
            this.ranges = new List<TaxRange>
            {
                ...
                new TaxRange { MinValue = 20261F, MaxValue= 25000F, Tax = 35F, TaxValue = 2508.2F },
        ...
        {
            var range = this.ranges.Single(i => i.IsInRange(income));

            var taxedIncome = range.Tax * income / 100;
