namespace FarfetchForAll.Simulator.Scenario
{
    ...
    public class BuyAndSellCoverCostsScenario : SimulationScenario
    {
        ...
        //    var remainingShares = sharesInfo.StockOptions.Sum(i => i.Amount) - sharesToCoverCosts;

        //    sharesInfo.Sell(sharesToCoverCosts, acquisitionValue, 2019);
        //    sharesInfo.Sell(remainingShares, sellValue, 2020);
